...
public class InformacioLegal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_informacio_legal);
        contingut= findViewById(R.id.edtInformacioLegalContingut);
        contingut.setMovementMethod(new ScrollingMovementMethod());
        String contingut1="POLÍTICA DE PRIVACIDAD PARA APLICACIONES MÓVILES (APPS)Fecha última actualización:\n" +
                "\n" +
                "De conformidad con el Reglamento (UE) 2016/679, del Parlamento Europeo y del Consejo, de 27 de abril de 2016, relativo a la protección de las personas físicas en lo que respecta al tratamiento de datos personales y a la libre circulación de estos datos (Reglamento General de Protección de Datos – RGPD), EMPRESA, informa a los usuarios de la aplicación Pet Hotel Finder (en adelante, la Aplicación), acerca del tratamiento de los datos personales, que ellos voluntariamente hayan facilitado durante el proceso de registro, acceso y utilización del servicio.\n" +
                "\n" +
                "1. IDENTIFICACIÓN DEL RESPONSABLE DEL TRATAMIENTO\n" +
                "\n" +
                "EMPRESA, con CIF/NIF n.º: B-76345879 y domicilio a efectos de notificaciones en: Seu d’Urgell, carrer de la Germandat de Sant Sebastià, 1 e inscrita en el Registro Mercantil de_________________ Tomo _________, Folio ___________, Sección ª, Hoja _______, inscripción ª (en adelante, el Responsable del Tratamiento), es la entidad responsable del tratamiento de los datos facilitados por los clientes de la Aplicación (en adelante, el/los Usuario/s).\n" +
                "\n" +
                ...
                "\n" +
                "EMPRESA, informa al Usuario de que le asisten los derechos de acceso, rectificación, limitación, supresión, oposición y portabilidad, los cuales podrá ejercitar mediante petición dirigida al correo electrónico: PetHotelFinder@gmail.com\n" +
                "\n" +
                ...
                "\n" +
                "En caso de que el Usuario quiera darse de baja a la hora de recibir las citadas comunicaciones, podrá hacerlo remitiendo su voluntad por e-mail al correo electrónico: ";
        contingut.setText(contingut1);
    }
}